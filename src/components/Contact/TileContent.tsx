            ...
            <div key={7} className='flex items-center justify-start w-full h-full'>
                <div className='grid grid-cols-1 grid-rows-1 ml-[20%]'>
                    <div className='flex justify-center items-center col-start-1 row-start-1'>
                        <ScrollText style={getMedallionSize(84)} className={`${getAccent(6, 'text')}`} />
                    </div>
                    <div className='flex justify-center items-center col-start-1 row-start-1'>
                        <Circle style={getMedallionSize(132)} className={`${getAccent(6, 'text')}`} />
                    </div>
                </div>
                <div className='absolute w-[80%] h-[70%] cursor-pointer'
...
export const getContent = (contentID: number) => {
    return {
        ...
        back: contentID === 1 || contentID === 7 ? <BackContentComponent contentID={contentID} /> : undefined
    };
}